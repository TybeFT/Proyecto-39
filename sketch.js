...
function preload(){
  trex_running =   loadAnimation("run1.png","run2.png","run3.png","run4.png","run5.png","run6.png","run7.png","run8.png");
  trex_collided = loadAnimation("d1.png","d2.png","d3.png","d4.png","d5.png","d6.png","d7.png");
